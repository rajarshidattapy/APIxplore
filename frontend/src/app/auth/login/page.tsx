            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gray-950 flex-col justify-between p-12 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <blockquote className="text-xl text-gray-300 leading-relaxed mb-4">
                        &ldquo;Secure API exploration with real-time policy analysis and threat detection.&rdquo;
                    </blockquote>
                    <p className="text-sm text-cyan-400 font-mono">— Design principle</p>
                </div>
            ...
            <div className="w-full lg:w-1/2 bg-gray-900 flex flex-col">
                ...
                <div className="flex-1 flex items-center justify-center px-6 pb-12">
                    <div className="w-full max-w-sm">
                        {/* Header */}
                        <div className="mb-8">
                            <h1 className="text-2xl font-bold text-white mb-2">Sign in to API Explorer</h1>
                            <p className="text-gray-400">Get instant, policy-aware API analysis and insights.</p>
                        </div>
                        ...
                        {/* Email/Password info */}
                        <p className="text-xs text-gray-500 mb-4">Use your email and password to sign in</p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full py-3 px-4 bg-cyan-500 text-gray-900 font-semibold rounded-lg hover:bg-cyan-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-900 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                            >
                        ...
                        <p className="mt-6 text-sm text-gray-400 text-center">
                            No account yet?{' '}
                            <Link href="/auth/signup" className="text-cyan-400 hover:text-cyan-300 underline">
                                Create one
                            </Link>
                            .
                        </p>
